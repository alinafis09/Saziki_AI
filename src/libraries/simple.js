...
export function serialize() {
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        isBaileys: {
            get() {
                try {
                    ...
                    const baileysStarts = ['BAE5', '3EB0', 'B24E', '8SCO'];
                    return baileysStarts.some(prefix => messageId.startsWith(prefix)) || false;
                } catch (e) {
        ...
        mentionedJid: {
            get() {
                try {
                    const mentioned = this.conn?.parseMention?.(this.text) || 
                    ...
                    return Object.defineProperties(
                        JSON.parse(
                            ...
                            sender: {
                                get() {
                                    try {
                                        return contextInfo.participant || self.chat || "";
                                    } catch (e) {
